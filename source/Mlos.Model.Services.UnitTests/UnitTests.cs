...
namespace Mlos.Model.Services.UnitTests
{
    ...
    /*
     This code only exists to help explain some of the remaining parts of the repo and to serve as a demo in case
    JSON serialization is added to other parts of the project.
