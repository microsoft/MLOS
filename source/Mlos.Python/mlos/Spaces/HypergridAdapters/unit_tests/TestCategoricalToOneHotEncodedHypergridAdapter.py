...
from mlos.Spaces.HypergridAdapters import CategoricalToOneHotEncodedHypergridAdapter, HierarchicalToFlatHypergridAdapter, \
    CategoricalToDiscreteHypergridAdapter, DiscreteToUnitContinuousHypergridAdapter
...
class TestCategoricalToOneHotEncodedHypergridAdapter(unittest.TestCase):
    ...
    def test_projecting_point_from_categorical_to_one_hot_encoding_simple_hypergrid(self):
        ...
        self._test_projecting_categorical_to_one_hot_encoding_point_from_adaptee(adaptee=self.simple_hypergrid, adapter=adapter)
    ...
    def test_projecting_dataframe_from_categorical_to_one_hot_encoding_simple_hypergrid(self):
    ...
    def test_projecting_point_from_hierarchical_categorical_to_one_hot_encoding_hypergrid(self):
        ...
        self._test_projecting_categorical_to_one_hot_encoding_point_from_adaptee(adaptee=self.hierarchical_hypergrid, adapter=hierarchical_adapter)

    def _test_projecting_categorical_to_one_hot_encoding_point_from_adaptee(self, adaptee, adapter):
    ...
    def test_projecting_point_from_categorical_hierachical_to_one_hot_encoding_flat_hypergrid(self):
    ...
    def test_projecting_dataframe_from_categorical_hierarchical_to_one_hot_encoding_flat_hypergrid(self):
