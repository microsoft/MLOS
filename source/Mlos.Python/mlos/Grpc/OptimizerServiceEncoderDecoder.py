...
class OptimizerServiceEncoder:
    ...
    dimension_types_to_pb2_types = {
        CategoricalDimension: OptimizerShared_pb2.DimensionType.CATEGORICAL,
        ContinuousDimension: OptimizerShared_pb2.DimensionType.CONTINUOUS,
        DiscreteDimension: OptimizerShared_pb2.DimensionType.DISCRETE,
        OrdinalDimension: OptimizerShared_pb2.DimensionType.ORDINAL
    }

    @staticmethod
    def encode_hypergrid(hypergrid: SimpleHypergrid) -> OptimizerShared_pb2.SimpleHypergrid:
        ...
        return OptimizerShared_pb2.SimpleHypergrid(
            Name=hypergrid.name,
    ...
    def encode_optimization_problem(optimization_problem: OptimizationProblem) -> OptimizerShared_pb2.OptimizationProblem:
        """
        return OptimizerShared_pb2.OptimizationProblem(
            ParameterSpace=OptimizerShared_pb2.SimpleHypergrid(SimpleHypergridJsonString=json.dumps(optimization_problem.parameter_space, cls=SimpleHypergridJsonEncoder)),
            ObjectiveSpace=OptimizerShared_pb2.SimpleHypergrid(SimpleHypergridJsonString=json.dumps(optimization_problem.objective_space, cls=SimpleHypergridJsonEncoder)),
            Objectives=[OptimizerShared_pb2.Objective(Name=objective.name, Minimize=objective.minimize) for objective in optimization_problem.objectives],
            ContextSpace=None if optimization_problem.context_space is None
            else OptimizerShared_pb2.SimpleHypergrid(SimpleHypergridJsonString=json.dumps(optimization_problem.context_space, cls=SimpleHypergridJsonEncoder))
        )"""
        return OptimizerShared_pb2.OptimizationProblem(
    ...
    @staticmethod
    def encode_continuous_dimension(dimension: ContinuousDimension) -> OptimizerShared_pb2.ContinuousDimension:
        assert isinstance(dimension, ContinuousDimension)
        return OptimizerShared_pb2.ContinuousDimension(
            Name=dimension.name,
            Min=dimension.min,
            Max=dimension.max,
    ...
    @staticmethod
    def encode_discrete_dimension(dimension: DiscreteDimension) -> OptimizerShared_pb2.DiscreteDimension:
        assert isinstance(dimension, DiscreteDimension)
        return OptimizerShared_pb2.DiscreteDimension(Name=dimension.name, Min=dimension.min, Max=dimension.max)

    @staticmethod
    def encode_empty_dimension(dimension: EmptyDimension) -> OptimizerShared_pb2.EmptyDimension:
        assert isinstance(dimension, EmptyDimension)
        return OptimizerShared_pb2.EmptyDimension(Name=dimension.name, DimensionType=OptimizerServiceEncoder.dimension_types_to_pb2_types[dimension.type])

    @staticmethod
    def encode_categorical_dimension(dimension: CategoricalDimension) -> OptimizerShared_pb2.CategoricalDimension:
        assert isinstance(dimension, CategoricalDimension)
        return OptimizerShared_pb2.CategoricalDimension(
            Name=dimension.name,
            Values=[OptimizerServiceEncoder.encode_primitive_value(value) for value in dimension.values]
        )

    @staticmethod
    def encode_ordinal_dimension(dimension: OrdinalDimension) -> OptimizerShared_pb2.OrdinalDimension:
        assert isinstance(dimension, OrdinalDimension)
        return OptimizerShared_pb2.OrdinalDimension(
            Name=dimension.name,
    ...
    @staticmethod
    def encode_composite_dimension(dimension: CompositeDimension) -> OptimizerShared_pb2.CompositeDimension:
        ...
        for chunk in dimension.enumerate_chunks():
            if dimension.chunks_type is ContinuousDimension:
                encoded_chunks.append(OptimizerShared_pb2.Dimension(ContinuousDimension=OptimizerServiceEncoder.encode_continuous_dimension(chunk)))
            elif dimension.chunks_type is DiscreteDimension:
                encoded_chunks.append(OptimizerShared_pb2.Dimension(DiscreteDimension=OptimizerServiceEncoder.encode_discrete_dimension(chunk)))
            elif dimension.chunks_type is OrdinalDimension:
                encoded_chunks.append(OptimizerShared_pb2.Dimension(OrdinalDimension=OptimizerServiceEncoder.encode_ordinal_dimension(chunk)))
            elif dimension.chunks_type is CategoricalDimension:
                encoded_chunks.append(
                    OptimizerShared_pb2.Dimension(CategoricalDimension=OptimizerServiceEncoder.encode_categorical_dimension(chunk))
                )
            else:
                raise TypeError(f"Unsupported chunk type: {dimension.chunks_type.__name__}")

        return OptimizerShared_pb2.CompositeDimension(
            Name=dimension.name,
    ...
    @staticmethod
    def encode_dimension(dimension: Dimension) -> OptimizerShared_pb2.Dimension:
        if isinstance(dimension, EmptyDimension):
            return OptimizerShared_pb2.Dimension(EmptyDimension=OptimizerServiceEncoder.encode_empty_dimension(dimension))

        if isinstance(dimension, ContinuousDimension):
            return OptimizerShared_pb2.Dimension(ContinuousDimension=OptimizerServiceEncoder.encode_continuous_dimension(dimension))

        if isinstance(dimension, DiscreteDimension):
            return OptimizerShared_pb2.Dimension(DiscreteDimension=OptimizerServiceEncoder.encode_discrete_dimension(dimension))

        if isinstance(dimension, OrdinalDimension):
            return OptimizerShared_pb2.Dimension(OrdinalDimension=OptimizerServiceEncoder.encode_ordinal_dimension(dimension))

        if isinstance(dimension, CategoricalDimension):
            return OptimizerShared_pb2.Dimension(CategoricalDimension=OptimizerServiceEncoder.encode_categorical_dimension(dimension))

        if isinstance(dimension, CompositeDimension):
            return OptimizerShared_pb2.Dimension(CompositeDimension=OptimizerServiceEncoder.encode_composite_dimension(dimension))

        raise TypeError(f"Unsupported dimension type: {type(dimension)}")

    @staticmethod
    def encode_subgrid(subgrid: SimpleHypergrid.JoinedSubgrid) -> OptimizerShared_pb2.GuestSubgrid:
        assert isinstance(subgrid, SimpleHypergrid.JoinedSubgrid)
        return OptimizerShared_pb2.GuestSubgrid(
    ...
    @staticmethod
    def encode_primitive_value(value: Union[int, float, bool, str]) -> OptimizerShared_pb2.PrimitiveValue:
        assert isinstance(value, (int, float, bool, str))
        if isinstance(value, bool):
            return OptimizerShared_pb2.PrimitiveValue(BoolValue=value)
        if isinstance(value, int):
            return OptimizerShared_pb2.PrimitiveValue(IntValue=value)
        if isinstance(value, float):
            return OptimizerShared_pb2.PrimitiveValue(DoubleValue=value)
        if isinstance(value, str):
            return OptimizerShared_pb2.PrimitiveValue(StringValue=value)
...
class OptimizerServiceDecoder:
    ...
    pb2_dimension_types_to_dimension_types = {
        OptimizerShared_pb2.DimensionType.CATEGORICAL: CategoricalDimension,
        OptimizerShared_pb2.DimensionType.CONTINUOUS: ContinuousDimension,
        OptimizerShared_pb2.DimensionType.DISCRETE: DiscreteDimension,
        OptimizerShared_pb2.DimensionType.ORDINAL: OrdinalDimension
    }
    ...
    @staticmethod
    def decode_continuous_dimension(serialized: OptimizerShared_pb2.ContinuousDimension) -> ContinuousDimension:
        assert isinstance(serialized, OptimizerShared_pb2.ContinuousDimension)
    ...
    @staticmethod
    def decode_discrete_dimension(serialized: OptimizerShared_pb2.DiscreteDimension) -> DiscreteDimension:
        assert isinstance(serialized, OptimizerShared_pb2.DiscreteDimension)
        return DiscreteDimension(name=serialized.Name, min=serialized.Min, max=serialized.Max)

    @staticmethod
    def decode_empty_dimension(serialized: OptimizerShared_pb2.EmptyDimension) -> EmptyDimension:
        assert isinstance(serialized, OptimizerShared_pb2.EmptyDimension)
    ...
    @staticmethod
    def decode_categorical_dimension(serialized: OptimizerShared_pb2.CategoricalDimension) -> CategoricalDimension:
        assert isinstance(serialized, OptimizerShared_pb2.CategoricalDimension)
    ...
    @staticmethod
    def decode_ordinal_dimension(serialized: OptimizerShared_pb2.OrdinalDimension) -> OrdinalDimension:
        assert isinstance(serialized, OptimizerShared_pb2.OrdinalDimension)
    ...
    @staticmethod
    def decode_composite_dimension(serialized: OptimizerShared_pb2.CompositeDimension) -> CompositeDimension:
        assert isinstance(serialized, OptimizerShared_pb2.CompositeDimension)

        if serialized.ChunkType == OptimizerShared_pb2.DimensionType.CONTINUOUS:
    ...
    @staticmethod
    def decode_hypergrid(hypergrid: OptimizerShared_pb2.SimpleHypergrid) -> SimpleHypergrid:
        assert isinstance(hypergrid, OptimizerShared_pb2.SimpleHypergrid)
    ...
    @staticmethod
    def decode_dimension(dimension: OptimizerShared_pb2.Dimension) -> Dimension:
        assert isinstance(dimension, OptimizerShared_pb2.Dimension)
    ...
    @staticmethod
    def decode_subgrid(subgrid: OptimizerShared_pb2.GuestSubgrid) -> SimpleHypergrid.JoinedSubgrid:
        assert isinstance(subgrid, OptimizerShared_pb2.GuestSubgrid)
    ...
    @staticmethod
    def decode_primitive_value(value: OptimizerShared_pb2.PrimitiveValue) -> Union[int, float, bool, str]:
