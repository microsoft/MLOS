...
_OPTIMIZATIONPROBLEM = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_ContextSpace', full_name='mlos.optimizer_monitoring_service.OptimizationProblem._ContextSpace',
