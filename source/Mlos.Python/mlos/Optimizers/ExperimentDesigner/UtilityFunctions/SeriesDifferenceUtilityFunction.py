...
class SeriesDifferenceUtilityFunction(UtilityFunction):
    ...
    def __call__(self, feature_values_pandas_frame):
        ...
        feature_values_pandas_frame = feature_values_pandas_frame.merge(series_vals_df, how="cross")
        print(feature_values_pandas_frame)
        ...
        print("result")
        print(self.series_objective.series_valuation_function)
        print(self.series_objective.series_valuation_function([1,4,9]))
        print(predictions_df)
        # TODO ZACK: Vectorize this. I'm sure pandas/numpy can do this faster than I can. @Adam, do you know how?
        ...
        for series in resulting_series_arry:
            series_valuations.append(self.series_objective.series_valuation_function(series))

        print(len(series_valuations))
        print(series_valuations[0])
