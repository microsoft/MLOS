...
class TestMultiObjectiveRegressionEnhancedRandomForest:

    @classmethod
    def setup_class(cls) -> None:
        mlos.global_values.declare_singletons()
        cls.logger = create_logger("TestMultiObjectiveRegressionEnhancedRandomForest")
    ...
    def test_default_config(self, objective_function_config_name):
        ...
        rerf_model_config = regression_enhanced_random_forest_config_store.default
        multi_objective_rf = MultiObjectiveRegressionEnhancedRandomForest(
            model_config=rerf_model_config,
