...
7. Run our configuration through `mlos_bench`.
    ...
    ./mlos_bench/mlos_bench/run_bench.py \
        ...
        --experimentId RedisBench \                          # Experiment name (can be in global_config.json)
        --runId 1                                            # Unique experiment ID (can come from the persistent storage service)
    ```
...
./mlos_bench/mlos_bench/run_opt.py \
    ...
    --runId 1                                            # Trial ID (can come from the persistent storage service)
```
