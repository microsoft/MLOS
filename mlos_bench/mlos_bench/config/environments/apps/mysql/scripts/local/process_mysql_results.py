...
#
"""
Script for post-processing mysql-benchmark results.
"""
...
def _main(input_file: str, output_file: str) -> None:
    """
    Re-shape mysql benchmark CSV results from wide to long.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Post-process mysql benchmark results.")
    parser.add_argument("input", help="mysql benchmark results (downloaded from a remote VM).")
    parser.add_argument("output", help="Converted mysql benchmark data" +
