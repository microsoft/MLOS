...
def _exp_data(
    ...
    run_exp: Callable[[SqlStorage, SqlStorage.Experiment], ExperimentData] = _dummy_run_exp,
) -> ExperimentData:
    """Test fixture for ExperimentData."""
    return run_exp(storage, exp_storage)


def _exp_no_tunables_data(
    storage: SqlStorage,
    exp_no_tunables_storage: SqlStorage.Experiment,
    run_exp: Callable[[SqlStorage, SqlStorage.Experiment], ExperimentData] = _dummy_run_exp,
) -> ExperimentData:
    """Test fixture for ExperimentData with no tunable configs."""
    return run_exp(storage, exp_no_tunables_storage)


def _mixed_numerics_exp_data(
    storage: SqlStorage,
    mixed_numerics_exp_storage: SqlStorage.Experiment,
    run_exp: Callable[[SqlStorage, SqlStorage.Experiment], ExperimentData] = _dummy_run_exp,
) -> ExperimentData:
    """Test fixture for ExperimentData with mixed numerical tunable types."""
    return run_exp(storage, mixed_numerics_exp_storage)
...
def exp_data(
    ...
    """Test fixture for ExperimentData."""
    return _exp_data(storage, exp_storage)


@pytest.fixture
def parallel_exp_data(
    storage: SqlStorage,
    exp_storage: SqlStorage.Experiment,
) -> ExperimentData:
    """Test fixture for ExperimentData with parallel scheduling."""
    return _exp_data(storage, exp_storage, run_exp=_parallel_dummy_run_exp)
...
def exp_no_tunables_data(
    ...
    """Test fixture for ExperimentData with no tunable configs."""
    return _exp_no_tunables_data(storage, exp_no_tunables_storage)
...
def mixed_numerics_exp_data(
    ...
    """Test fixture for ExperimentData with mixed numerical tunable types."""
    return _mixed_numerics_exp_data(storage, mixed_numerics_exp_storage)
