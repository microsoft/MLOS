...
def test_tunable_to_hyperparameter_categorical(tunable_categorical) -> None:
    """
...
def test_tunable_to_hyperparameter_int(tunable_int) -> None:
    """
...
def test_tunable_to_hyperparameter_float(tunable_float) -> None:
    """
