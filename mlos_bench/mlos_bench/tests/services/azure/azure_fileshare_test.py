"""
Tests for mlos_bench.environment.azure.azure_fileshare
"""
...
@patch("mlos_bench.environment.azure.azure_fileshare.open")
@patch("mlos_bench.environment.azure.azure_fileshare.os.makedirs")
...
@patch("mlos_bench.environment.azure.azure_fileshare.open")
@patch("mlos_bench.environment.azure.azure_fileshare.os.path.isdir")
...
@patch("mlos_bench.environment.azure.azure_fileshare.open")
@patch("mlos_bench.environment.azure.azure_fileshare.os.path.isdir")
@patch("mlos_bench.environment.azure.azure_fileshare.os.scandir")
