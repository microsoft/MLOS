...
def test_init_mlos_core_smac_opt_max_trials(tunable_groups: TunableGroups) -> None:
    ...
    assert (
        opt._opt.base_optimizer.scenario.n_trials == test_opt_config["max_suggestions"]
    )


def test_init_mlos_core_smac_absolute_output_directory(
...
def test_init_mlos_core_smac_relative_output_directory(
    tunable_groups: TunableGroups,
) -> None:
    """
...
def test_init_mlos_core_smac_temp_output_directory(
    tunable_groups: TunableGroups,
) -> None:
    """
