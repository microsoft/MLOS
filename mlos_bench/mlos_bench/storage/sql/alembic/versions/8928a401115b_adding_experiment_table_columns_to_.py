...
def upgrade() -> None:
    ...
    op.add_column('experiment', sa.Column('ts_start', sa.DateTime(), nullable=False))
    ...
    op.add_column('experiment', sa.Column('experiment_worker_name', sa.String(length=40), nullable=True, comment='Worker Hostname'))
    op.add_column('experiment', sa.Column('experiment_worker_id', sa.Integer(), nullable=True, comment='Worker Process ID'))
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('experiment', 'experiment_worker_id')
    op.drop_column('experiment', 'experiment_worker_name')
