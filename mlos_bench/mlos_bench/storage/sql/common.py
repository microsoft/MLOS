    ...
    with engine.connect() as conn:
        ...
        cur_trials_stmt = (
            ...
            .where(
                schema.trial.c.exp_id == experiment_id,
                and_(
                    tunable_config_trial_group_id_subquery.c.exp_id
                    == schema.trial.c.exp_id,
                    tunable_config_trial_group_id_subquery.c.config_id
                    == schema.trial.c.config_id,
                ),
            )
            .order_by(
        ...
        return trials_df.merge(
            configs_df, on=["trial_id", "tunable_config_id"], how="left"
