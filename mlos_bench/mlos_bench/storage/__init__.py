...
- Retrieve the :py:class:`~mlos_bench.storage.base_trial_data.TrialData` results
  with a :py:class:`~mlos_bench.storage.base_experiment_data.ExperimentData`
  instance. These can be especially useful with :py:mod:`mlos_viz` for interactive
  exploration in a Jupyter Notebook interface, for instance.
